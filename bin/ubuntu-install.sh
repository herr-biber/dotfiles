...
PACKAGES_MANUAL="ack-grep adobe-flashplugin android-tools-adb android-tools-adbd android-tools-fastboot browser-plugin-freshplayer-pepperflash chromium-browser gconf2 ipython ipython-notebook libopencv-dev lm-sensors openssh-server pdftk skype git-gui"
